        ...
        try:
            ...
            try:
                ...
                if exp:
                    ...
                    if current_time > exp:
                        logger.warning(f"JWT token has expired. Exp: {exp}, Current: {current_time}, Difference: {current_time - exp} seconds")
                        raise HTTPException(
                            status_code=401, 
                            detail={
                        ...
                        logger.debug(f"Token is valid for {exp - current_time} more seconds")
            ...
            logger.debug("Fetching public keys from Clerk...")
