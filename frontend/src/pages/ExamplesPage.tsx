  ...
  const examples = [
    {
      ...
      category: "calculus",
      prompt:
        "Plot the graph of y = sin(x) from -2π to 2π showing how it emerges from the unit circle",
      videoUrl: "/examples/sin-graph.mp4",
      description:
        "Animated visualization connecting the unit circle to the sine function graph.",
      duration: "45s",
      complexity: "Beginner",
    ...
    },
    {
      ...
      description:
        "Elegant text animation using Manim's Write effect for smooth character-by-character reveal.",
      duration: "30s",
      complexity: "Beginner",
    ...
    },
    {
      ...
      category: "algebra",
      prompt:
        "Animate a dot moving along the curve y = x^2 from x = -3 to x = 3",
      videoUrl: "/examples/parabola-trace.mp4",
      description:
        "Dynamic visualization of quadratic function with animated point tracing the curve path.",
      duration: "60s",
    ...
    },
    {
      ...
      category: "geometry",
      prompt:
        "Visualize vector addition of (2,1) and (1,2) from the origin with arrow representations",
      videoUrl: "/examples/vector-addition.mp4",
      description:
        "Clear demonstration of vector addition using arrow graphics and coordinate system.",
      duration: "40s",
      complexity: "Intermediate",
    ...
    },
    {
      ...
      description:
        "Linear algebra transformation visualized on a 2D grid showing shape deformation.",
      duration: "55s",
      complexity: "Advanced",
    ...
    },
    {
      ...
      description:
        "Geometric projection demonstration showing relationship between points and coordinate axes.",
      duration: "35s",
      complexity: "Beginner",
    ...
    <div className="min-h-screen">
      ...
      <section className="pt-20 pb-12 lg:pt-28 lg:pb-16 relative">
        ...
        <div className="container-narrow relative">
          <div className="text-center space-y-6 max-w-3xl mx-auto">
            ...
            <p
              className={`text-lg text-secondary leading-relaxed transition-all duration-700 animate-delay-200 ${
                mounted ? "animate-slide-up" : "opacity-0"
              }`}
            >
              Explore these examples to see how Animathic transforms
              mathematical concepts into engaging visual content. Each animation
              was created from a simple text prompt.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pb-8">
        <div className="container-narrow">
          <div
            className={`transition-all duration-700 animate-delay-300 ${
        ...
        <div className="container-narrow">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredExamples.map((example, index) => (
              <div
                key={example.id}
                className={`surface-primary rounded-2xl overflow-hidden border border-subtle hover-lift hover-scale group transition-all duration-700 ${
              ...
              >
                ...
                <div className="aspect-video bg-surface-tertiary relative overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3">
                    <span
                      className={`px-2 py-1 rounded-lg text-xs font-medium ${getComplexityColor(
                        example.complexity
                      )}`}
                    >
                      {example.complexity}
